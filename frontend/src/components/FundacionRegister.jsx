...
const FundacionRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('/api/auth/registro/fundacion/', {
        method: 'POST',
        headers: {
    ...
    <div className="register-container">
      <div className="register-card">
        <div className="register-header">
          <h1><i className="fas fa-building"></i> Registro de Fundación</h1>
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-group">
              <label htmlFor="nombre">
                <i className="fas fa-building"></i> Nombre de la Fundación*
              </label>
              <input 
                type="text" 
                id="nombre" 
            ...
            <div className="form-group">
              <label htmlFor="rut">
                <i className="fas fa-id-card"></i> RUT de la Fundación*
              </label>
              <input 
                type="text" 
                id="rut" 
            ...
            <div className="form-group">
              <label htmlFor="descripcion">
                <i className="fas fa-info-circle"></i> Descripción de la Fundación*
              </label>
              <textarea 
                id="descripcion" 
                name="descripcion" 
                ...
                placeholder="Describe brevemente la misión, visión y trabajo de tu fundación..."
                required
              ></textarea>
            ...
            >
              {isLoading ? (
                ...
                <span><i className="fas fa-building"></i> Crear Cuenta</span>
              )}
            </button>
          </form>
          
          <div className="login-link">
            ¿Ya tienes una cuenta? <Link to="/login/fundacion">Iniciar Sesión</Link>
          </div>
...
export default FundacionRegister;
