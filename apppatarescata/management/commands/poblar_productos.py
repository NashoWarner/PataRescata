...
class Command(BaseCommand):
    help = 'Puebla la base de datos con productos y juguetes de ejemplo.'
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS('Productos y juguetes creados o actualizados exitosamente.'))
